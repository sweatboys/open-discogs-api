...
public class ReleaseVideoRecord extends UpdatableRecordImpl<ReleaseVideoRecord> implements
   ...
   */
  public ReleaseVideoRecord(Integer releaseId, String description, String title, String url,
      Long urlHash, LocalDateTime updatedAt) {
    super(ReleaseVideo.RELEASE_VIDEO);
  ...
  /**
   * Setter for <code>public.release_video.url_hash</code>. fnv32 encoded hash from url
   */
  ...
  @Override
  public ReleaseVideoRecord values(Integer value1, String value2, String value3, String value4,
