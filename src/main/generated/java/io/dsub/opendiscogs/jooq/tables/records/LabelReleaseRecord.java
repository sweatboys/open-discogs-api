...
public class LabelReleaseRecord extends UpdatableRecordImpl<LabelReleaseRecord> implements Record4<Integer, Integer, String, LocalDateTime> {
    ...
    @Override
    public LabelReleaseRecord values(Integer value1, Integer value2, String value3, LocalDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LabelReleaseRecord(Integer labelId, Integer releaseId, String categoryNotation, LocalDateTime updatedAt) {
        super(LabelRelease.LABEL_RELEASE);
