...
public class Artist extends TableImpl<ArtistRecord> {
     ...
     */
    public final TableField<ArtistRecord, Integer> ID = createField(DSL.name("id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.artist.data_quality</code>.
     */
    public final TableField<ArtistRecord, String> DATA_QUALITY = createField(DSL.name("data_quality"), SQLDataType.VARCHAR(100), this, "");

    /**
     * The column <code>public.artist.name</code>.
     */
    public final TableField<ArtistRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(1000), this, "");

    /**
     * The column <code>public.artist.profile</code>.
     */
    public final TableField<ArtistRecord, String> PROFILE = createField(DSL.name("profile"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>public.artist.real_name</code>.
     */
    public final TableField<ArtistRecord, String> REAL_NAME = createField(DSL.name("real_name"), SQLDataType.VARCHAR(2000), this, "");
