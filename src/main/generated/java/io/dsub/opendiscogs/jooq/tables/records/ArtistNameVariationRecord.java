...
public class ArtistNameVariationRecord extends UpdatableRecordImpl<ArtistNameVariationRecord> implements Record4<Integer, String, Long, LocalDateTime> {
    ...
    /**
     * Setter for <code>public.artist_name_variation.name_variation_hash</code>.
    ...
    /**
     * Setter for <code>public.artist_name_variation.updated_at</code>. created
     * time
     */
    ...
    @Override
    public ArtistNameVariationRecord values(Integer value1, String value2, Long value3, LocalDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ArtistNameVariationRecord(Integer artistId, String nameVariation, Long nameVariationHash, LocalDateTime updatedAt) {
        super(ArtistNameVariation.ARTIST_NAME_VARIATION);
     ...
     * Create a detached, initialised ArtistNameVariationRecord
     */
    public ArtistNameVariationRecord(io.dsub.opendiscogs.jooq.tables.pojos.ArtistNameVariation value) {
        super(ArtistNameVariation.ARTIST_NAME_VARIATION);
