...
public class GinTrgmConsistent extends AbstractRoutine<Boolean> {
   ...
   */
  public static final Parameter<Short> _2 = Internal.createParameter("_2", SQLDataType.SMALLINT,
      false, true);
  /**
   * The parameter <code>public.gin_trgm_consistent._3</code>.
   */
  public static final Parameter<String> _3 = Internal.createParameter("_3", SQLDataType.CLOB, false,
      true);
  /**
   * The parameter <code>public.gin_trgm_consistent._4</code>.
   */
  public static final Parameter<Integer> _4 = Internal.createParameter("_4", SQLDataType.INTEGER,
      false, true);
  /**
   * @deprecated Unknown data type. If this is a qualified, user-defined type, it may have been
   * excluded from code generation. If this is a built-in type, you can define an explicit
   ...
   */
  @Deprecated
  public static final Parameter<Object> _5 = Internal.createParameter("_5",
      org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""), false, true);
  /**
   * @deprecated Unknown data type. If this is a qualified, user-defined type, it may have been
   * excluded from code generation. If this is a built-in type, you can define an explicit
   ...
   */
  @Deprecated
  public static final Parameter<Object> _6 = Internal.createParameter("_6",
      org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""), false, true);
  /**
   * @deprecated Unknown data type. If this is a qualified, user-defined type, it may have been
   * excluded from code generation. If this is a built-in type, you can define an explicit
   ...
   */
  @Deprecated
  public static final Parameter<Object> _7 = Internal.createParameter("_7",
      org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""), false, true);
  /**
   * @deprecated Unknown data type. If this is a qualified, user-defined type, it may have been
   * excluded from code generation. If this is a built-in type, you can define an explicit
   ...
   */
  @Deprecated
  public static final Parameter<Object> _8 = Internal.createParameter("_8",
      org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""), false, true);
