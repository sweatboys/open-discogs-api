...
public class ArtistAlias extends TableImpl<ArtistAliasRecord> {
   ...
   */
  public final TableField<ArtistAliasRecord, Integer> ARTIST_ID = createField(DSL.name("artist_id"),
      SQLDataType.INTEGER.nullable(false), this, "");
  /**
   * The column <code>public.artist_alias.alias_id</code>.
   */
  public final TableField<ArtistAliasRecord, Integer> ALIAS_ID = createField(DSL.name("alias_id"),
      SQLDataType.INTEGER.nullable(false), this, "");
  /**
   * The column <code>public.artist_alias.updated_at</code>. created time
   */
  public final TableField<ArtistAliasRecord, LocalDateTime> UPDATED_AT = createField(
  ...
  public List<ForeignKey<ArtistAliasRecord, ?>> getReferences() {
    return Arrays.asList(Keys.ARTIST_ALIAS__FK_ARTIST_ALIAS_ARTIST_ID_ARTIST,
        Keys.ARTIST_ALIAS__FK_ARTIST_ALIAS_ALIAS_ID_ARTIST);
  }

  /**
   * Get the implicit join path to the <code>public.artist</code> table, via the
   * <code>fk_artist_alias_artist_id_artist</code> key.
   */
  public Artist fkArtistAliasArtistIdArtist() {
      if (_fkArtistAliasArtistIdArtist == null) {
          _fkArtistAliasArtistIdArtist = new Artist(this,
              Keys.ARTIST_ALIAS__FK_ARTIST_ALIAS_ARTIST_ID_ARTIST);
      }
  ...
  /**
   * Get the implicit join path to the <code>public.artist</code> table, via the
   * <code>fk_artist_alias_alias_id_artist</code> key.
   */
  public Artist fkArtistAliasAliasIdArtist() {
      if (_fkArtistAliasAliasIdArtist == null) {
          _fkArtistAliasAliasIdArtist = new Artist(this,
              Keys.ARTIST_ALIAS__FK_ARTIST_ALIAS_ALIAS_ID_ARTIST);
      }
