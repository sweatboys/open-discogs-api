...
public class ArtistGroup extends TableImpl<ArtistGroupRecord> {
     ...
     */
    public final TableField<ArtistGroupRecord, Integer> ARTIST_ID = createField(DSL.name("artist_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.artist_group.group_id</code>.
     */
    public final TableField<ArtistGroupRecord, Integer> GROUP_ID = createField(DSL.name("group_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.artist_group.updated_at</code>. created time
     */
    public final TableField<ArtistGroupRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now()", SQLDataType.LOCALDATETIME)), this, "created time");
    ...
    public List<ForeignKey<ArtistGroupRecord, ?>> getReferences() {
        return Arrays.asList(Keys.ARTIST_GROUP__FK_ARTIST_GROUP_ARTIST_ID_ARTIST, Keys.ARTIST_GROUP__FK_ARTIST_GROUP_GROUP_ID_ARTIST);
    }
     ...
     * the <code>fk_artist_group_artist_id_artist</code> key.
     */
    public Artist fkArtistGroupArtistIdArtist() {
        if (_fkArtistGroupArtistIdArtist == null)
            _fkArtistGroupArtistIdArtist = new Artist(this, Keys.ARTIST_GROUP__FK_ARTIST_GROUP_ARTIST_ID_ARTIST);
    ...
    /**
     * Get the implicit join path to the <code>public.artist</code> table, via
     * the <code>fk_artist_group_group_id_artist</code> key.
     */
    public Artist fkArtistGroupGroupIdArtist() {
        if (_fkArtistGroupGroupIdArtist == null)
            _fkArtistGroupGroupIdArtist = new Artist(this, Keys.ARTIST_GROUP__FK_ARTIST_GROUP_GROUP_ID_ARTIST);
