...
public class MasterStyle extends TableImpl<MasterStyleRecord> {
   ...
   */
  public final TableField<MasterStyleRecord, Integer> MASTER_ID = createField(DSL.name("master_id"),
      SQLDataType.INTEGER.nullable(false), this, "");
  /**
   * The column <code>public.master_style.style_id</code>.
   */
  public final TableField<MasterStyleRecord, Integer> STYLE_ID = createField(DSL.name("style_id"),
      SQLDataType.INTEGER.nullable(false), this, "");
  /**
   * The column <code>public.master_style.updated_at</code>. created time
   */
  public final TableField<MasterStyleRecord, LocalDateTime> UPDATED_AT = createField(
  ...
  public List<ForeignKey<MasterStyleRecord, ?>> getReferences() {
    return Arrays.asList(Keys.MASTER_STYLE__FK_MASTER_STYLE_MASTER_ID_MASTER,
        Keys.MASTER_STYLE__FK_MASTER_STYLE_STYLE_ID_STYLE);
  }
