...
public class ReleaseImageRecord extends UpdatableRecordImpl<ReleaseImageRecord> implements Record4<Integer, Long, String, LocalDateTime> {
    ...
    /**
     * Setter for <code>public.release_image.url_hash</code>. fnv32 encoded hash
     * from url
     */
    ...
    /**
     * Getter for <code>public.release_image.url_hash</code>. fnv32 encoded hash
     * from url
     */
    ...
    @Override
    public ReleaseImageRecord values(Integer value1, Long value2, String value3, LocalDateTime value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
