...
public class ReleaseTrackRecord extends UpdatableRecordImpl<ReleaseTrackRecord> implements Record6<Integer, String, String, String, Long, LocalDateTime> {
    ...
    /**
     * Setter for <code>public.release_track.title_hash</code>. fnv32 encoded
     * hash from title
     */
    ...
    @Override
    public ReleaseTrackRecord values(Integer value1, String value2, String value3, String value4, Long value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ReleaseTrackRecord(Integer releaseId, String duration, String position, String title, Long titleHash, LocalDateTime updatedAt) {
        super(ReleaseTrack.RELEASE_TRACK);
