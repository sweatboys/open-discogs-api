...
public class Master extends TableImpl<MasterRecord> {
   ...
   */
  public final TableField<MasterRecord, Integer> ID = createField(DSL.name("id"),
      SQLDataType.INTEGER.nullable(false), this, "");
  /**
   * The column <code>public.master.data_quality</code>.
   */
  public final TableField<MasterRecord, String> DATA_QUALITY = createField(DSL.name("data_quality"),
      SQLDataType.VARCHAR(100), this, "");
  /**
   * The column <code>public.master.title</code>.
   */
  public final TableField<MasterRecord, String> TITLE = createField(DSL.name("title"),
      SQLDataType.VARCHAR(2000), this, "");
  /**
   * The column <code>public.master.released_year</code>.
   */
  public final TableField<MasterRecord, Short> RELEASED_YEAR = createField(
  ...
  public <U> SelectField<U> mapping(
      Function4<? super Integer, ? super String, ? super String, ? super Short, ? extends U> from) {
