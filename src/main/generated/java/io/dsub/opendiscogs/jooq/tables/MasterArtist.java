...
public class MasterArtist extends TableImpl<MasterArtistRecord> {
     ...
     */
    public final TableField<MasterArtistRecord, Integer> ARTIST_ID = createField(DSL.name("artist_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.master_artist.master_id</code>.
     */
    public final TableField<MasterArtistRecord, Integer> MASTER_ID = createField(DSL.name("master_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.master_artist.updated_at</code>. created time
     */
    public final TableField<MasterArtistRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now()", SQLDataType.LOCALDATETIME)), this, "created time");
    ...
    public List<ForeignKey<MasterArtistRecord, ?>> getReferences() {
        return Arrays.asList(Keys.MASTER_ARTIST__FK_MASTER_ARTIST_ARTIST_ID_ARTIST, Keys.MASTER_ARTIST__FK_MASTER_ARTIST_MASTER_ID_MASTER);
    }
