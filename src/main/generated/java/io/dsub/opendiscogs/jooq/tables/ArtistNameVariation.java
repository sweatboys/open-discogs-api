...
public class ArtistNameVariation extends TableImpl<ArtistNameVariationRecord> {
   ...
   */
  public final TableField<ArtistNameVariationRecord, Integer> ARTIST_ID = createField(
   ...
   */
  public final TableField<ArtistNameVariationRecord, String> NAME_VARIATION = createField(
      DSL.name("name_variation"), SQLDataType.VARCHAR(2000).nullable(false), this, "");
  /**
   * The column <code>public.artist_name_variation.name_variation_hash</code>. fnv32 encoded hash
   * from name_variation
   */
  public final TableField<ArtistNameVariationRecord, Long> NAME_VARIATION_HASH = createField(
      DSL.name("name_variation_hash"), SQLDataType.BIGINT.nullable(false), this,
      "fnv32 encoded hash from name_variation");
  /**
   * The column <code>public.artist_name_variation.updated_at</code>. created time
   */
  public final TableField<ArtistNameVariationRecord, LocalDateTime> UPDATED_AT = createField(
  ...
  /**
   * Create an aliased <code>public.artist_name_variation</code> table reference
   */
  ...
  public <O extends Record> ArtistNameVariation(Table<O> child,
      ForeignKey<O, ArtistNameVariationRecord> key) {
  ...
  public Artist artist() {
      if (_artist == null) {
          _artist = new Artist(this,
              Keys.ARTIST_NAME_VARIATION__FK_ARTIST_NAME_VARIATION_ARTIST_ID_ARTIST);
      }
  ...
  public <U> SelectField<U> mapping(
      Function4<? super Integer, ? super String, ? super Long, ? super LocalDateTime, ? extends U> from) {
