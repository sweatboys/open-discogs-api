...
public class ReleaseImage extends TableImpl<ReleaseImageRecord> {
     ...
     */
    public final TableField<ReleaseImageRecord, Integer> RELEASE_ID = createField(DSL.name("release_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.release_image.url_hash</code>. fnv32 encoded hash
     * from url
     */
    public final TableField<ReleaseImageRecord, Long> URL_HASH = createField(DSL.name("url_hash"), SQLDataType.BIGINT.nullable(false), this, "fnv32 encoded hash from url");

    /**
     * The column <code>public.release_image.url</code>.
     */
    public final TableField<ReleaseImageRecord, String> URL = createField(DSL.name("url"), SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>public.release_image.updated_at</code>. created time
     */
    public final TableField<ReleaseImageRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now()", SQLDataType.LOCALDATETIME)), this, "created time");
