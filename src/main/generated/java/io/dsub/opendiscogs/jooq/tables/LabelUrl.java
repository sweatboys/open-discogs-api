...
public class LabelUrl extends TableImpl<LabelUrlRecord> {
     ...
     */
    public final TableField<LabelUrlRecord, Integer> LABEL_ID = createField(DSL.name("label_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.label_url.url_hash</code>. fnv32 encoded hash
     * from url
     */
    public final TableField<LabelUrlRecord, Long> URL_HASH = createField(DSL.name("url_hash"), SQLDataType.BIGINT.nullable(false), this, "fnv32 encoded hash from url");

    /**
     * The column <code>public.label_url.url</code>.
     */
    public final TableField<LabelUrlRecord, String> URL = createField(DSL.name("url"), SQLDataType.VARCHAR(2048).nullable(false), this, "");

    /**
     * The column <code>public.label_url.updated_at</code>. created time
     */
    public final TableField<LabelUrlRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now()", SQLDataType.LOCALDATETIME)), this, "created time");
