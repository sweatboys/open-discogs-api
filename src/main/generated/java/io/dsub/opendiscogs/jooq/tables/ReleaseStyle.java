...
public class ReleaseStyle extends TableImpl<ReleaseStyleRecord> {
   ...
   */
  public final TableField<ReleaseStyleRecord, Integer> RELEASE_ID = createField(
      DSL.name("release_id"), SQLDataType.INTEGER.nullable(false), this, "");
  /**
   * The column <code>public.release_style.style_id</code>.
   */
  public final TableField<ReleaseStyleRecord, Integer> STYLE_ID = createField(DSL.name("style_id"),
      SQLDataType.INTEGER.nullable(false), this, "");
  /**
   * The column <code>public.release_style.updated_at</code>. created time
   */
  public final TableField<ReleaseStyleRecord, LocalDateTime> UPDATED_AT = createField(
  ...
  public List<ForeignKey<ReleaseStyleRecord, ?>> getReferences() {
    return Arrays.asList(Keys.RELEASE_STYLE__FK_RELEASE_STYLE_RELEASE_ID_RELEASE,
        Keys.RELEASE_STYLE__FK_RELEASE_STYLE_STYLE_ID_STYLE);
  }
