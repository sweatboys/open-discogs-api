...
public class Label extends TableImpl<LabelRecord> {
   ...
   */
  public final TableField<LabelRecord, Integer> ID = createField(DSL.name("id"),
      SQLDataType.INTEGER.nullable(false), this, "");
  /**
   * The column <code>public.label.contact_info</code>.
   */
  public final TableField<LabelRecord, String> CONTACT_INFO = createField(DSL.name("contact_info"),
      SQLDataType.CLOB, this, "");
  /**
   * The column <code>public.label.data_quality</code>.
   */
  public final TableField<LabelRecord, String> DATA_QUALITY = createField(DSL.name("data_quality"),
      SQLDataType.VARCHAR(100), this, "");
  /**
   * The column <code>public.label.name</code>.
   */
  public final TableField<LabelRecord, String> NAME = createField(DSL.name("name"),
      SQLDataType.VARCHAR(300), this, "");
  /**
   * The column <code>public.label.profile</code>.
   */
  public final TableField<LabelRecord, String> PROFILE = createField(DSL.name("profile"),
      SQLDataType.CLOB, this, "");
  /**
   * The column <code>public.label.parent_id</code>.
   */
  public final TableField<LabelRecord, Integer> PARENT_ID = createField(DSL.name("parent_id"),
  ...
  public <U> SelectField<U> mapping(
      Function6<? super Integer, ? super String, ? super String, ? super String, ? super String, ? super Integer, ? extends U> from) {
