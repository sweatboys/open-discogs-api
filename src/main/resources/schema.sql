...
ALTER TABLE "release"
    ADD CONSTRAINT "fk_release_master_id_master" FOREIGN KEY ("master_id") REFERENCES "master" ("id");
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_release_title_trigram ON release USING GIN (UPPER("title") gin_trgm_ops);
