 ...
 */
public class R2dbcDataAutoConfiguration__TestContext002_BeanDefinitions {
  /**
  ...
  public static BeanDefinition getRdbcManagedTypesBeanDefinition() {
    ...
    RootBeanDefinition beanDefinition = new RootBeanDefinition(beanType);
    beanDefinition.setInstanceSupplier(R2dbcDataAutoConfiguration__TestContext002_BeanDefinitions.rdbcManagedTypesInstance());
    return beanDefinition;
  }
